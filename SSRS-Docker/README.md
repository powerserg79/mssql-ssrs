...
```
docker run -d -p 1433:1433 -p 80:80 -v C:/temp/:C:/temp/ -e sa_password=Qwerty12345! -e ACCEPT_EULA=Y -e ssrs_user=SSRSAdmin -e ssrs_password=Qwerty12345! --memory 6048mb ss-ssrs:angus
```
